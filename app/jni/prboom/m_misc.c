...
default_t defaults[] =
{
  ...
  {"screen_width",{&desired_screenwidth},{1920}, 320, MAX_SCREENWIDTH,
   def_int,ss_none},
  {"screen_height",{&desired_screenheight},{1080},200,MAX_SCREENHEIGHT,
   def_int,ss_none},
  ...
  {"use_doublebuffer",{&use_doublebuffer},{1},0,1,             // proff 2001-7-4
   def_bool,ss_none}, // enable doubledbuffer to avoid display tearing (fullscreen)
#endif
